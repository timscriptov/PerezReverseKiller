...
LOCAL_SRC_FILES := ELFHash.cpp mainfunction.cpp zlibmgr.cpp rarext.cpp oat2dex.cpp parse_elf.cpp odex2dex.cpp zipa.cpp dumpdex_main.cpp $(QRCODE_FILES) $(DUMPDEX_FILES) $(RAR_FILES) $(LIB_FILES) $(ZIPA_FILES) $(ASTYLE_FILES)
...
LOCAL_CFLAGS := -DASTYLE_JNI -DSILENT -DRARDLL -I$(LOCAL_PATH)/rar -fexceptions -Os -ffunction-sections -fdata-sections -fvisibility=hidden -w -Wl,--gc-sections
